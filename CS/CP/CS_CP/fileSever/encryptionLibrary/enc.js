...
function Encrypt_JSON(json_data, key){
    ...
    for (var i = 0; i < b.length; ++i){
        ...
        enc_word.push(aes.Encrypt_AES(charCode));
    }
...
function Encrypt_Key(aes_key, key1, key2){
    return rsa.Encrypt_RSA(rsa.Encrypt_RSA(aes_key,key1), key2);
}

function Decrypt_Key(enc_aes_key, key1, key2){
    return rsa.Decrypt_RSA(rsa.Decrypt_RSA(enc_aes_key,key2), key1);
}
