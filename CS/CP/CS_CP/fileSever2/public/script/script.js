...
function addElements(data){
    ...
    for(var i = 0; i < data.length; i++){
        ...
        link.href='http://localhost:3002/fileserver/getFile/'+link.text;
...
function fetchData(){
    var temp_url = "http://localhost:3002/fileserver/getFileList";
    get_req(temp_url);
...
function accessServer(){
    temp_url = "http://localhost:3002/accessServer"
    // data = {
    //     name: "sau22rane",
