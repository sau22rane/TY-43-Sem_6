...
void worst_fit(vector<Process> *processes, vector<Mem_Block*> *rem_mem_blocks, vector<Mem_Block*> *all_mem_blocks);
...
int main(){
    ...
    worst_fit(&processes, &rem_mem_blocks, &all_mem_blocks);
